...
const address = require('../static/address');
const barData = require('../static/charts/bar');
const lineData = require('../static/charts/line');
const pieData = require('../static/charts/pie');
const tableData = require('../static/tables/tables');
const formData = require('../static/form/form');
const formData1 = require('../static/form/form1');
...
apiRoutes.get('/getFormData1', function (req, res) {
  res.json({
    errno: 0,
    data: formData1
  });
